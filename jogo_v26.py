...
assets['casapoder'] =  pygame.image.load('imagens/casapoder.png').convert_alpha()
assets['casapoder'] = pygame.transform.scale(assets['casapoder'], (casa_largura, casa_altura))
